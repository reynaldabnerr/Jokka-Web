        ...
        <div className="about-content">
          ...
          <div className="about-image-container">
            ...
            <div className="about-text">
              <h2>About Jokka</h2>
              <p>
                Jokka merupakan platform informasi terdepan untuk menjelajahi kekayaan kota Makassar.
                Sebagai aplikasi web yang berfokus pada destinasi wisata, acara, dan kuliner terbaik di Makassar,
                Jokka hadir untuk memberikan panduan menyeluruh, baik warga lokal maupun wisatawan,
                yang ingin menikmati dan mengeksplorasi setiap sudut kota dengan cara yang berbeda.
              </p>
              <p>
                Kami berkomitmen untuk terus memberikan informasi terkini, terpercaya, dan inspiratif agar Anda
                dapat merasakan pengalaman terbaik di kota Makassar. Jelajahi kota ini bersama Jokka dan temukan
                sisi terbaik dari Makassar yang belum Anda kenal.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="why-choose-us">
          ...
          <div className="reason-boxes">
            <div className="reason-box">
              ...
              <img src="https://i.pinimg.com/564x/a7/e4/ee/a7e4ee2fca989f18c24bb70ce2e9b2ca.jpg" alt="Destinasi" className="reason-image" />
              <p>
                Temukan rekomendasi destinasi wisata unggulan, mulai dari keindahan alam, situs bersejarah, hingga landmark ikonik yang mencerminkan keragaman budaya Makassar.
              </p>
            </div>
            <div className="reason-box">
              <h3>Informasi Acara Terkini</h3>
              <p> <img src="https://i.pinimg.com/564x/db/8a/28/db8a28812d50d77a337f51028fa3eea5.jpg" alt="Acara Terkini" className="reason-image" />
                Dapatkan informasi terbaru mengenai acara-acara menarik di Makassar, seperti festival budaya, pameran seni, hingga konser yang menggugah antusiasme.
              </p>
            </div>
            <div className="reason-box">
              <h3>Pengalaman Kuliner Autentik</h3>
              <img src="https://i.pinimg.com/474x/cb/e1/5c/cbe15cacc2eb8a00250bf4a95bd1b491.jpg" alt="Kuliner" className="reason-image" />
              <p>
                Eksplorasi dunia kuliner Makassar dengan rekomendasi tempat makan yang menggugah selera, dari makanan khas hingga kuliner modern yang memanjakan lidah.
              </p>
            </div>
          </div>
        </div>
